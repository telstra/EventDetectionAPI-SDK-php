...
class AuthenticationApi
{
     ...
     * @return \Telstra_EventDetection\Model\OAuthResponse
     */
     ...
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Telstra_EventDetection\Model\OAuthResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function authTokenWithHttpInfo($client_id, $client_secret, $grant_type)
    {
        $returnType = '\Telstra_EventDetection\Model\OAuthResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Telstra_EventDetection\Model\OAuthResponse',
