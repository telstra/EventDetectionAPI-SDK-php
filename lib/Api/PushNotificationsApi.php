...
class PushNotificationsApi
{
     ...
     * @param  \Telstra_EventDetection\Model\NotificationPayload $body Application Id, MSISDN, Event Id and Event Date (required)
     *
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Telstra_EventDetection\Model\PushNotificationObj
     */
    public function pushNotifications($content_type, $body)
    {
        list($response) = $this->pushNotificationsWithHttpInfo($content_type, $body);
        return $response;
    }
     ...
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Telstra_EventDetection\Model\PushNotificationObj, HTTP status code, HTTP response headers (array of strings)
     */
    public function pushNotificationsWithHttpInfo($content_type, $body)
    {
        $returnType = '\Telstra_EventDetection\Model\PushNotificationObj';
        $request = $this->pushNotificationsRequest($content_type, $body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Telstra_EventDetection\Model\PushNotificationObj',
     ...
     */
    public function pushNotificationsAsync($content_type, $body)
    {
        return $this->pushNotificationsAsyncWithHttpInfo($content_type, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pushNotificationsAsyncWithHttpInfo($content_type, $body)
    {
        $returnType = '\Telstra_EventDetection\Model\PushNotificationObj';
        $request = $this->pushNotificationsRequest($content_type, $body);
     ...
     */
    protected function pushNotificationsRequest($content_type, $body)
    {
        // verify the required parameter 'content_type' is set
        if ($content_type === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_type when calling pushNotifications'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling pushNotifications'
            );
        }

        $resourcePath = '/v1/eventdetection/events/notifications';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
