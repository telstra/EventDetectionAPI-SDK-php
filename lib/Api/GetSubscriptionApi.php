...
/**
 * GetSubscriptionApi Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
...
class GetSubscriptionApi
{
     ...
     *
     * @param  \Telstra_EventDetection\Model\PhoneNumberList $body List of subscribed phone numbers (required)
     *
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Telstra_EventDetection\Model\GetSubscriptionResponse
     */
    public function getSubscription($body)
    {
        list($response) = $this->getSubscriptionWithHttpInfo($body);
        return $response;
    }
     ...
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Telstra_EventDetection\Model\GetSubscriptionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscriptionWithHttpInfo($body)
    {
        $returnType = '\Telstra_EventDetection\Model\GetSubscriptionResponse';
        $request = $this->getSubscriptionRequest($body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Telstra_EventDetection\Model\GetSubscriptionResponse',
     ...
     */
    public function getSubscriptionAsync($body)
    {
        return $this->getSubscriptionAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubscriptionAsyncWithHttpInfo($body)
    {
        $returnType = '\Telstra_EventDetection\Model\GetSubscriptionResponse';
        $request = $this->getSubscriptionRequest($body);
     ...
     */
    protected function getSubscriptionRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling getSubscription'
            );
        }

        $resourcePath = '/v1/eventdetection/events/subscriptions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
