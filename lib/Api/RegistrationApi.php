...
class RegistrationApi
{
     ...
     * Register
     *
     * @param  \Telstra_EventDetection\Model\SubscriptionObj $body Subscribe with a list of phone numbers, push notification URL (optional) and the event type. (required)
     *
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Telstra_EventDetection\Model\ResisterPhoneNumberList
     */
     ...
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Telstra_EventDetection\Model\ResisterPhoneNumberList, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerWithHttpInfo($body)
    {
        $returnType = '\Telstra_EventDetection\Model\ResisterPhoneNumberList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Telstra_EventDetection\Model\ResisterPhoneNumberList',
    ...
    protected function registerRequest($body)
    {
        ...
        $resourcePath = '/v1/eventdetection/events';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Unregister
     *
     * @param  string $event_type Event Type. Value can be simswap (required)
     * @param  \Telstra_EventDetection\Model\UnregisterRequestObj $body List of subscribed phone numbers and notification URL (optional) (required)
     *
     * @throws \Telstra_EventDetection\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Telstra_EventDetection\Model\ResisterPhoneNumberList
     */
    public function unregister($event_type, $body)
    {
        list($response) = $this->unregisterWithHttpInfo($event_type, $body);
        return $response;
    }
     ...
     * @return array of \Telstra_EventDetection\Model\ResisterPhoneNumberList, HTTP status code, HTTP response headers (array of strings)
     */
    public function unregisterWithHttpInfo($event_type, $body)
    {
        $returnType = '\Telstra_EventDetection\Model\ResisterPhoneNumberList';
        $request = $this->unregisterRequest($event_type, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unregisterAsync($event_type, $body)
    {
        return $this->unregisterAsyncWithHttpInfo($event_type, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unregisterAsyncWithHttpInfo($event_type, $body)
    {
        $returnType = '\Telstra_EventDetection\Model\ResisterPhoneNumberList';
        $request = $this->unregisterRequest($event_type, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unregisterRequest($event_type, $body)
    {
        // verify the required parameter 'event_type' is set
        if ($event_type === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_type when calling unregister'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling unregister'
            );
        }
