 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetEventResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetEventResponse';
    ...
    protected static $swaggerTypes = [
        'event_type' => 'string',
        'msisdns' => '\Telstra_EventDetection\Model\Eventsattr[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['msisdns'] = isset($data['msisdns']) ? $data['msisdns'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['msisdns'] === null) {
            $invalidProperties[] = "'msisdns' can't be null";
        }
     ...
     * Sets event_type
     *
     * @param string $event_type Name of the event
     *
     * @return $this
     */
     ...
     * Gets msisdns
     *
     * @return \Telstra_EventDetection\Model\Eventsattr[]
     */
    public function getMsisdns()
    {
        return $this->container['msisdns'];
    }

    /**
     * Sets msisdns
     *
     * @param \Telstra_EventDetection\Model\Eventsattr[] $msisdns Array containing the object with evnt attributes
     *
     * @return $this
     */
    public function setMsisdns($msisdns)
    {
        $this->container['msisdns'] = $msisdns;
