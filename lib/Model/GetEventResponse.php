...
class GetEventResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'eventname' => 'string',
        'phone_numbers' => '\Telstra_EventDetection\Model\Eventsattr[]'
    ];
     ...
     * Sets phone_numbers
     *
     * @param \Telstra_EventDetection\Model\Eventsattr[] $phone_numbers Array containing the object with evnt attributes
     *
     * @return $this
     */
