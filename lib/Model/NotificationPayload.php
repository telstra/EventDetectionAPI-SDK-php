...
/**
 * NotificationPayload Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NotificationPayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotificationPayload';
     ...
     * Sets event_date
     *
     * @param string $event_date Event timestamp
     *
     * @return $this
     */
