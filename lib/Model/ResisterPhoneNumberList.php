...
/**
 * ResisterPhoneNumberList Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResisterPhoneNumberList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResisterPhoneNumberList';
    ...
    protected static $swaggerTypes = [
        'msisdns' => '\Telstra_EventDetection\Model\Test[]'
    ];
     ...
     * Gets msisdns
     *
     * @return \Telstra_EventDetection\Model\Test[]
     */
     ...
     * Sets msisdns
     *
     * @param \Telstra_EventDetection\Model\Test[] $msisdns MSISDNs array
     *
     * @return $this
     */
