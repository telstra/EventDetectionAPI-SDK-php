...
/**
 * PhoneNumberList Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PhoneNumberList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PhoneNumberList';
     ...
     * Sets msisdns
     *
     * @param string[] $msisdns MSISDN list
     *
     * @return $this
     */
