...
/**
 * Subscriptionattr Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Subscriptionattr implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Subscriptionattr';
     ...
     * Sets events
     *
     * @param string[] $events Array of subscribed events
     *
     * @return $this
     */
     ...
     * Sets carrier_name
     *
     * @param string $carrier_name Carrier name for the MSISDN
     *
     * @return $this
     */
