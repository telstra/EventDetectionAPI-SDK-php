...
/**
 * UnregisterRequestObj Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UnregisterRequestObj implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UnregisterRequestObj';
     ...
     * Sets msisdns
     *
     * @param string[] $msisdns list of msisdns
     *
     * @return $this
     */
