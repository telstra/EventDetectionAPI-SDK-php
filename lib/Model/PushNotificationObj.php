...
/**
 * PushNotificationObj Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PushNotificationObj implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PushNotificationObj';
     ...
     * Sets event_date
     *
     * @param string $event_date Timestamp indicating when the event occured
     *
     * @return $this
     */
