...
class GetSubscriptionResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'subscriptions' => '\Telstra_EventDetection\Model\Subscriptionattr[]'
    ];
     ...
     * Gets subscriptions
     *
     * @return \Telstra_EventDetection\Model\Subscriptionattr[]
     */
     ...
     * Sets subscriptions
     *
     * @param \Telstra_EventDetection\Model\Subscriptionattr[] $subscriptions Array containing the object with values for phone number and subscription attributes
     *
     * @return $this
     */
