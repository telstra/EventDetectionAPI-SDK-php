...
/**
 * ServiceEventsAttr Class Doc Comment
 *
 * @category Class
 * @package  Telstra_EventDetection
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ServiceEventsAttr implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServiceEventsAttr';
     ...
     * Sets event_date
     *
     * @param string $event_date Array of subscribed events
     *
     * @return $this
     */
